...
start_ = "Привет\! Я был создан чтобы конвертировать валюты\,\nИспользуй команду */currency* чтобы конвертировать валюту\nИспользуй команду */cur_rate* чтобы узнать курс валюты\nИспользуй команду */get_abr* чтобы узнать абревиатуру валюты\nИспользуй команду */get_full_abr* чтобы получить список абревиатур"
